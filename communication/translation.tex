...
\newcommand{\addORCID}[1]{~\href{https://orcid.org/#1}{\includegraphics[width=1.5ex]{ORCID.png}}}
...
\pyfunction{../graceful_tadpoles.py}{graceful_tadpole}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{thm1}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{fig1}
...
\pyfunction{../graceful_tadpoles.py}{fig2}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{case_3_1}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{case_3_2}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{case_3_3}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{case_3_4}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{case_3_5}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{thm2}
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{fig3}
...
\label{sec3:even}
  ...
  \vspace{0.5\baselineskip}
  \pyfunction{../graceful_tadpoles.py}{fig4}
  ...
  \vspace{0.5\baselineskip}
  \pyfunction{../graceful_tadpoles.py}{fig5}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \vspace{0.5\baselineskip}
    \pyfunction{../graceful_tadpoles.py}{fig6} 
...
\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{is_graceful}

\additionalcomment{If you want to draw one of these tadpoles, there is the following function that may be of some use:}

\vspace{0.5\baselineskip}
\pyfunction{../graceful_tadpoles.py}{draw_graph}
